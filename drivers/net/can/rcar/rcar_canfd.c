...
#define RCANFD_GAFLCFG_SETRNC(gpriv, n, x) \
		(((x) & reg_rzt2h(gpriv, 0x1ff, 0xff)) << \
		(reg_rzt2h(gpriv, 16, 24) - ((n) & 1) * reg_rzt2h(gpriv, 16, 8)))

#define RCANFD_GAFLCFG_GETRNC(gpriv, n, x) \
		(((x) >> (reg_rzt2h(gpriv, 16, 24) - ((n) & 1) * reg_rzt2h(gpriv, 16, 8))) & \
		reg_rzt2h(gpriv, 0x1ff, 0xff))

/* RSCFDnCFDGAFLECTR / RSCFDnGAFLECTR */
#define RCANFD_GAFLECTR_AFLDAE		BIT(8)
#define RCANFD_GAFLECTR_AFLPN(gpriv, x)	((x) & reg_rzt2h(gpriv, 0x3f, 0x1f))
...
#define RCANFD_NCFG_NTSEG2(gpriv, x) \
	(((x) & reg_rzt2h(gpriv, 0x7f, 0x1f)) << reg_rzt2h(gpriv, 25, 24))

#define RCANFD_NCFG_NTSEG1(gpriv, x) \
	(((x) & reg_rzt2h(gpriv, 0xff, 0x7f)) << reg_rzt2h(gpriv, 17, 16))

#define RCANFD_NCFG_NSJW(gpriv, x) \
	(((x) & reg_rzt2h(gpriv, 0x7f, 0x1f)) << reg_rzt2h(gpriv, 10, 11))
...
/* RSCFDnCFDCmDCFG */
#define RCANFD_DCFG_DSJW(gpriv, x)	(((x) & reg_rzt2h(gpriv, 0xf, 0x7)) << 24)

#define RCANFD_DCFG_DTSEG2(gpriv, x) \
	(((x) & reg_rzt2h(gpriv, 0x0f, 0x7)) << reg_rzt2h(gpriv, 16, 20))

#define RCANFD_DCFG_DTSEG1(gpriv, x) \
	(((x) & reg_rzt2h(gpriv, 0x1f, 0xf)) << reg_rzt2h(gpriv, 8, 16))

#define RCANFD_DCFG_DBRP(x)		(((x) & 0xff) << 0)

/* RSCFDnCFDCmFDCFG */
#define RCANFD_FDCFG_CLOE		BIT(30)
#define RCANFD_FDCFG_REFE		BIT(29)
...
#define RCANFD_CFCC_CFTML(gpriv, x)	\
	(((x) & reg_rzt2h(gpriv, 0x1f, 0xf)) << reg_rzt2h(gpriv, 16, 20))
#define RCANFD_CFCC_CFM(gpriv, x)	(((x) & 0x3) << reg_rzt2h(gpriv,  8, 16))
#define RCANFD_CFCC_CFIM		BIT(12)
#define RCANFD_CFCC_CFDC(gpriv, x)	(((x) & 0x7) << reg_rzt2h(gpriv, 21,  8))
...
#define RCANFD_RFCC(gpriv, x)		(reg_rzt2h(gpriv, 0x00c0, 0x00b8) + (0x04 * (x)))
/* RSCFDnCFDRFSTSx / RSCFDnRFSTSx */
#define RCANFD_RFSTS(gpriv, x)		(reg_rzt2h(gpriv, 0x00e0, 0x00d8) + (0x04 * (x)))
/* RSCFDnCFDRFPCTRx / RSCFDnRFPCTRx */
#define RCANFD_RFPCTR(gpriv, x)		(reg_rzt2h(gpriv, 0x0100, 0x00f8) + (0x04 * (x)))

/* Common FIFO Control registers */

/* RSCFDnCFDCFCCx / RSCFDnCFCCx */
#define RCANFD_CFCC(gpriv, ch, idx)	(reg_rzt2h(gpriv, 0x0120, 0x0118) + (0x0c * (ch)) + \
					 (0x04 * (idx)))
/* RSCFDnCFDCFSTSx / RSCFDnCFSTSx */
#define RCANFD_CFSTS(gpriv, ch, idx)	(reg_rzt2h(gpriv, 0x01e0, 0x0178) + (0x0c * (ch)) + \
					 (0x04 * (idx)))
/* RSCFDnCFDCFPCTRx / RSCFDnCFPCTRx */
#define RCANFD_CFPCTR(gpriv, ch, idx)	(reg_rzt2h(gpriv, 0x0240, 0x01d8) + (0x0c * (ch)) + \
					 (0x04 * (idx)))
...
#define RCANFD_F_DCFG_OFFSET(gpriv)	(reg_rzt2h(gpriv, 0x1400, 0x0500))
#define RCANFD_F_DCFG(gpriv, m)		(RCANFD_F_DCFG_OFFSET(gpriv) + (0x20 * (m)))
#define RCANFD_F_CFDCFG(gpriv, m)	(RCANFD_F_DCFG_OFFSET(gpriv) + 0x04 + (0x20 * (m)))
#define RCANFD_F_CFDCTR(gpriv, m)	(RCANFD_F_DCFG_OFFSET(gpriv) + 0x08 + (0x20 * (m)))
#define RCANFD_F_CFDSTS(gpriv, m)	(RCANFD_F_DCFG_OFFSET(gpriv) + 0x0c + (0x20 * (m)))
#define RCANFD_F_CFDCRC(gpriv, m)	(RCANFD_F_DCFG_OFFSET(gpriv) + 0x10 + (0x20 * (m)))

/* RSCFDnCFDGAFLXXXj offset */
#define RCANFD_F_GAFL_OFFSET(gpriv)	(reg_rzt2h(gpriv, 0x1800, 0x1000))
...
#define RCANFD_F_RFOFFSET(gpriv)	(reg_rzt2h(gpriv, 0x6000, 0x3000))
#define RCANFD_F_RFID(gpriv, x)		(RCANFD_F_RFOFFSET(gpriv) + (0x80 * (x)))
#define RCANFD_F_RFPTR(gpriv, x)	(RCANFD_F_RFOFFSET(gpriv) + 0x04 + \
					 (0x80 * (x)))
#define RCANFD_F_RFFDSTS(gpriv, x)	(RCANFD_F_RFOFFSET(gpriv) + 0x08 + \
					 (0x80 * (x)))
#define RCANFD_F_RFDF(gpriv, x, df)	(RCANFD_F_RFOFFSET(gpriv) + 0x0c + \
					 (0x80 * (x)) + (0x04 * (df)))

/* RSCFDnCFDCFXXk -> RCANFD_F_CFXX(ch, k) */
#define RCANFD_F_CFOFFSET(gpriv)		(reg_rzt2h(gpriv, 0x6400, 0x3400))
#define RCANFD_F_CFID(gpriv, ch, idx)		(RCANFD_F_CFOFFSET(gpriv) + (0x180 * (ch)) + \
						(0x80 * (idx)))
#define RCANFD_F_CFPTR(gpriv, ch, idx)		(RCANFD_F_CFOFFSET(gpriv) + 0x04 + \
						(0x180 * (ch)) + (0x80 * (idx)))
#define RCANFD_F_CFFDCSTS(gpriv, ch, idx)	(RCANFD_F_CFOFFSET(gpriv) + 0x08 + \
						(0x180 * (ch)) + (0x80 * (idx)))
#define RCANFD_F_CFDF(gpriv, ch, idx, df)	(RCANFD_F_CFOFFSET(gpriv) + 0x0c + \
						(0x180 * (ch)) + (0x80 * (idx)) + \
						(0x04 * (df)))
...
#define RCANFD_T2H_FDCFG(m)		(0x1404 + (0x20 * (m)))
...
static const struct can_bittiming_const rzt2h_canfd_nom_bittiming_const = {
...
static const struct can_bittiming_const rzt2h_canfd_data_bittiming_const = {
	.name = RCANFD_DRV_NAME,
	.tseg1_min = 2,
	.tseg1_max = 32,
	.tseg2_min = 2,
...
static const struct rcar_canfd_hw_info rzt2h_hw_info = {
	.postdiv = 1,
	.max_channels = 2,
	.multi_channel_irqs = 1,
};
...
/* Helper functions */
static inline bool is_rzt2h(struct rcar_canfd_global *gpriv)
{
	return gpriv->info == &rzt2h_hw_info;
}

static inline u32 reg_rzt2h(struct rcar_canfd_global *gpriv,
					   u32 rzt2h, u32 not_rzt2h)
{
	return is_rzt2h(gpriv) ? rzt2h : not_rzt2h;
}
					 ...
					 struct net_device *ndev)
{
	...
	if (priv->can.ctrlmode & CAN_CTRLMODE_FD || is_rzt2h(gpriv)) {
		rcar_canfd_write(priv->base,
				    ...
				    u32 fcan_freq)
{
	...
	if (gpriv->fdmode) {
		if (is_rzt2h(gpriv)) {
			priv->can.bittiming_const = &rzt2h_canfd_nom_bittiming_const;
			priv->can.data_bittiming_const =
				&rzt2h_canfd_data_bittiming_const;
		} else {
...
static int rcar_canfd_probe(struct platform_device *pdev)
{
	...
	int g_err_irq, g_recc_irq, i;
	bool fdmode = true;			/* CAN FD only mode - default */
	char *name[RCANFD_NUM_CHANNELS] = {"channel0", "channel1"};
