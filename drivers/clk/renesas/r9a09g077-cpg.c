...
static const struct {
	...
	.common = {
		...
		DEF_MOD("mtu3",		R9A09G077_MTU3_CLK, R9A09G077_PCLKH,
					0x308, 0, 0),
		DEF_MOD("gpt0",		R9A09G077_GPT0_CLK, R9A09G077_PCLKH,
					0x308, 1, 0),
		DEF_MOD("gpt1",		R9A09G077_GPT1_CLK, R9A09G077_PCLKH,
					0x308, 2, 0),
		DEF_MOD("adc0",		R9A09G077_ACD0_CLK, R9A09G077_PCLKH,
					0x308, 6, 0),
		DEF_MOD("adc1",		R9A09G077_ACD1_CLK, R9A09G077_PCLKH,
					0x308, 7, 0),
		DEF_MOD("adc2",		R9A09G077_ACD2_CLK, R9A09G077_PCLKH,
					0x308, 16, 0),
